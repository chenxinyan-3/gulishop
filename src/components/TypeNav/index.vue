  ...
  methods:{
   // 转到app去写了
    ...
    toSearch(event){
      ...
      // 我们先去判断点击的是不是我们要委派的a标签
      // 我们点击的a标签有三种，分别带的参数是不同的，参数我们得区分开
...
// this.$route是当前页的路由对象，不是search的路由对象，是之前的
        if(this.$route.params){
          location.params=this.$route.params
        }
// 跳转 用的一定是push或replace
// push的这个this.$router这个是准备跳的
